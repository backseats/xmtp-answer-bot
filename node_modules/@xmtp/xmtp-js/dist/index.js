...
var SignedPrivateKey = class {
  ...
  async sign(digest) {
    const [signature6, recovery] = await secp2.sign(
      digest,
  ...
  validatePublicKey() {
    const generatedPublicKey = secp2.getPublicKey(this.secp256k1.bytes);
    return equalBytes(
      generatedPublicKey,
...
var { GetKeystoreStatusResponse_KeystoreStatus: KeystoreStatus2 } = keystore;
